...
const defaultConfig = {
	...
	xfdLogPageName: 'Nhật trình biểu quyết xóa',
	...
	watchSpeedyPages: ['c3', 'c5', 'c12'],
	watchSpeedyExpiry: '1 month',
	markSpeedyPagesAsPatrolled: false,
	promptForSpeedyDeletionSummary: [],
	warnUserOnSpeedyDelete: ['db', 'c1', 'c2', 'c3', 'c4', 'c6', 'c9', 'c11', 'c12', 'c13', 'c14', 'c15', 'bv1', 'bv2', 'bv3', 'bv4', 'tt1', 'tt2', 'tt3', 'tt4', 'tt5', 'tt6', 'tt7', 'tt8', 'tt9', 'tt10', 'tt11', 'dh2', 'dh3', 'dh4', 'ctt1', 'ctt2', 'tv3', 'tl1', 'tl2'],
	notifyUserOnSpeedyDeletionNomination: ['db', 'c1', 'c2', 'c3', 'c4', 'c6', 'c9', 'c11', 'c12', 'c13', 'c14', 'c15', 'bv1', 'bv2', 'bv3', 'bv4', 'tt1', 'tt2', 'tt3', 'tt4', 'tt5', 'tt6', 'tt7', 'tt8', 'tt9', 'tt10', 'tt11', 'dh2', 'dh3', 'dh4', 'ctt1', 'ctt2', 'tv3', 'tl1', 'tl2'],
	welcomeUserOnSpeedyDeletionNotification: ['db', 'c1', 'c2', 'c3', 'c4', 'c6', 'c9', 'c11', 'c12', 'c13', 'c14', 'c15', 'bv1', 'bv2', 'bv3', 'bv4', 'tt2', 'tt3', 'tt7', 'tt9', 'tt10', 'tt11', 'dh1', 'dh2', 'dh3', 'dh4', 'ctt1', 'ctt2', 'tv3', 'tl1', 'tl2'],
	...
	talkbackHeading: 'Thư mới từ ' + mw.config.get('wgUserName'),
...
export class Config {
	...
	static saveSuccess(pageobj) {
		...
		noticebox.innerHTML =
			'<p><b>Tùy chọn Twinkle của bạn đã được lưu.</b></p><p>Để xem thay đổi, bạn cần <b>xóa toàn bộ bộ nhớ đệm của trình duyệt</b> (xem <a href="' +
			mw.util.getUrl('WP:BYPASS') +
			'" title="WP:BYPASS">WP:BYPASS</a> để biết hướng dẫn).</p>';
	...
	static watchlistEnums = {
		'yes': 'Theo dõi (vô thời hạn)',
		'no': "Không theo dõi",
		'default': 'Theo tùy chọn của bạn',
		'1 week': 'Theo dõi 1 tuần',
		'1 month': 'Theo dõi 1 tháng',
		'3 months': 'Theo dõi 3 tháng',
		'6 months': 'Theo dõi 6 tháng',
	};
	...
	static commonSets = {
		...
		namespacesNoSpecial: {
			...
			10: 'Thảo luận',
			11: 'Thảo luận Thể loại',
			12: 'Trợ giúp',
			13: 'Thảo luận Trợ giúp',
			14: 'Thể loại',
			15: 'Thảo luận Thể loại',
			100: 'Cổng thông tin',
			101: 'Thảo luận Cổng thông tin',
			710: 'TimedText',
			711: 'Thảo luận TimedText',
			828: 'Mô đun',
